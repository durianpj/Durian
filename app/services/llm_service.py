...
def build_rag_prompt(question: str, context: str) -> str:
    ...
    prompt = f"""
        ...
        전화번호, 연락처, 휴대폰, 번호 질문이면 [검색 결과]의 "전화번호:" 값을 사용해서 "OO님의 전화번호는 OO입니다." 형식으로 답변하세요.
        사번이나 사원번호 질문이면 [검색 결과]의 "사번:" 값을 사용해서 "OO님의 사원번호는 OO입니다." 형식으로 답변하세요.
        이름 질문이면 [검색 결과]의 "이름:" 값을 사용해서 답변하세요.
